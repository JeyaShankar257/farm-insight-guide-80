...
frontend_origins = os.getenv(
    "ALLOWED_ORIGINS",
    "http://localhost:5173,http://localhost:4173,http://localhost:8082,http://localhost:8083,http://127.0.0.1:5173,http://127.0.0.1:4173,http://127.0.0.1:8082,http://127.0.0.1:8083",
).split(",")
app.add_middleware(
    CORSMiddleware,
